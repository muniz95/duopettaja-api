...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { alias: @level.alias, number: @level.number, score: @level.score } }, as: :json
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { alias: @level.alias, number: @level.number, score: @level.score } }, as: :json
    assert_response 200
  end
